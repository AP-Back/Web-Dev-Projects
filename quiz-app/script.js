...
function setQuestion(index) {
  ...
  let answers = [
    questionsData[index].correct_answer,
    questionsData[index].incorrect_answers[0],
    questionsData[index].incorrect_answers[1],
    questionsData[index].incorrect_answers[2],
  ];
...
function endGame(message) {
  ...
  score.innerHTML = `${message} <br/> Your Score: <br/> ${(
    correctCount * scoreScale
  ).toString()}`;
}
